<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default-old.aspx.cs" Inherits="FreezerProPlugin.index" %>
...
<body id="body" runat="server">
    ...
    <div id="ffff" runat="server">
        <a href="javascript:OpenWindow('FpExtendPage.aspx')">点击</a>
    </div>
    <div>
        <%--    <div>
    <!--登陆框-->
    ...
    <!--主体显示面板-->
    <div id="mainopanels" class="easyui-window" style="width: 60%; height: 60%; padding: 0px;" border="false" title="FP功能扩展" closed="true" runat="server" enableviewstate="false" runat="server">
        <!--菜单按钮区-->
        <div id="menu" style="padding: 5px,10px" runat="server">
            ...
            <a id="respondhis" name="barcodeimportbtn" href="#" class="easyui-linkbutton" onclick="reshis()">回发</a>
            <a href="#" id="huoqu" name="huoqu" class="easyui-linkbutton" onclick="getName()">获取</a>
        </div>
        <!--显示面板-->
            ...
            <table id="sampleSourceDataGrid" class="easyui-datagrid" title="样品源信息" style="width: 100%"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'sampleSourceDescription',editor:'text'" width="15%">源描述</th>
                        <th data-options="field:'patientName'" width="10%">姓名</th>
                        <th data-options="field:'importStatus'" width="10%">状态</th>
                        <th data-options="field:'scheduledDateTime'" width="15%">预约手术日期</th>
                        <th data-options="field:'diagBeforeOperation'" width="20%">主要诊断</th>
                        <th data-options="field:'patientId'" hidden="hidden"></th>
