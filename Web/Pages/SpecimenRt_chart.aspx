...
<!--统计图页面-->
<!--chart页面:SpecimenRt_chart.aspx-->
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecimenRt_chart.aspx.cs" Inherits="RuRo.SpecimenRt_chart" %>
...
<div id="printBody"> 
<div class="ftitle">主要作用是用于判断是否需要回发给His--统计图
