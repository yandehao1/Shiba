...
<!--datagrid页面:LabTestMaster_list.aspx-->
...
<table id="datagrid" title="LabTestMaster" class="easyui-datagrid" style="width:auto;height:460px"
    ...
    <thead>    
			<tr>
                ...
                <th field="priorityindicator" width="100" sortable="true">优先标志</th>
                ...
                <th field="orderingprovider" width="100" sortable="true">医生工号</th>
                <th field="performedby" width="100" sortable="true">执行科室</th>
                <th field="resultstatus" width="100" sortable="true">执行情况</th>
                <th field="resultsrptdatetime" width="100" sortable="true">报告完成时间</th>
                <th field="transcriptionist" width="100" sortable="true">报告者工号</th>
                <th field="verifiedby" width="100" sortable="true">审核者工号</th>
            </tr>
    </thead>
</table>
