...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info_info.aspx.cs" Inherits="RuRo.Web.Info_info" %>
...
<div data-options="region:'south'" style="height: 40px; background: #f2f2f2;">
    ...
    <script type="text/javascript">
        ...
        function saveForm() {
            ...
            if (isEmptyStr(卡号)||isEmptyStr(住院号)){
                ShowMsg("卡号或住院号为空"); return;
            }
            if (isEmptyStr(sampleSourceType)) {
                ShowMsg("请选择样品源类型"); return;
            }
            var count = Math.random();
            var url = "../../Sever/Info_handler.ashx" + "?count" + count;
            ajaxLoading();
            //$.ajax({
            //    type: "POST",
