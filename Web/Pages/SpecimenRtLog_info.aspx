...
<!--form页面:SpecimenRtLog_info.aspx-->
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecimenRtLog_info.aspx.cs" Inherits="RuRo.SpecimenRtLog_info" %>
...
<div class="ftitle">回发数据记录存档</div>
    <form id="frmAjax" method="post" novalidate>
        ...
        <div class="fitem">
            <div class="label">回发此数据的用户:</div>
            <div class="control"><input  id="username"  name="username"   /></div>
        </div>
        <div class="fitem">
            <div class="label">回发的患者唯一标识:</div>
            <div class="control"><input  id="patiendid"  name="patiendid"   /></div>
        </div>
        <div class="fitem">
            <div class="label">回发的样本id:</div>
            <div class="control"><input  id="sampleid"  name="sampleid"   /></div>
        </div>
        <div class="fitem">
            <div class="label">回发后的状态:</div>
            <div class="control"><input  id="postbackstatus"  name="postbackstatus"   /></div>
        </div>
        <div class="fitem">
            <div class="label">回发时间:</div>
            <div class="control"><input  id="postbackdate"  name="postbackdate"  class="easyui-datebox" required="true"  /></div>
        </div>
    </form>
...
if(mode=='upd'|| mode=='inf'){ 
    url = 'SpecimenRtLog_handler.ashx?mode=inf&pk='+pk; 
...
if(mode=='ins') url = 'SpecimenRtLog_handler.ashx?mode=ins';
if(mode=='upd') url = 'SpecimenRtLog_handler.ashx?mode=upd&pk='+pk;
