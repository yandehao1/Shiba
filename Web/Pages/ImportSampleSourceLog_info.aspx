...
<!--form页面:ImportSampleSourceLog_info.aspx-->
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportSampleSourceLog_info.aspx.cs" Inherits="RuRo.ImportSampleSourceLog_info" %>
...
<div id="printBody"> 
<div class="ftitle">FP中样本源记录</div>
    <form id="frmAjax" method="post" novalidate>
        <!--如需控制表单控件为必填项，请增加class="easyui-validatebox" required="true" -->
        <div class="fitem">
            <div class="label">自增列:</div>
            <div class="control"><input id="id"  name="id"  disabled="disabled" /></div>
        </div>
        <div class="fitem">
            <div class="label">样本源Name:</div>
            <div class="control"><input  id="samplesourcename"  name="samplesourcename"   /></div>
        </div>
        <div class="fitem">
            <div class="label">样本源类型:</div>
            <div class="control"><input  id="samplesourcetype"  name="samplesourcetype"   /></div>
        </div>
        <div class="fitem">
            <div class="label">样本源描述:</div>
            <div class="control"><input  id="samplesourcedescription"  name="samplesourcedescription"   /></div>
        </div>
        <div class="fitem">
            <div class="label">患者唯一标识:</div>
        ...
        <div class="fitem">
            ...
            <div class="control"><input  id="patientsex"  name="patientsex"   /></div>
        </div>
        <div class="fitem">
            <div class="label">导入数据之前的状态:</div>
            <div class="control"><input  id="importstatus"  name="importstatus"   /></div>
        </div>
        <div class="fitem">
            <div class="label">隐藏域数据:</div>
            <div class="control"><textarea  id="hidden"  name="hidden"  ></textarea></div>
        </div>
        <div class="fitem">
            <div class="label">导入数据之后的状态:</div>
            <div class="control"><textarea  id="resultstatus"  name="resultstatus"  ></textarea></div>
        </div>
        <div class="fitem">
            <div class="label">执行导入的时间:</div>
            <div class="control"><input  id="importdate"  name="importdate"  class="easyui-datebox" required="true"  /></div>
        </div>
    </form>
...
if(mode=='upd'|| mode=='inf'){ 
    url = 'ImportSampleSourceLog_handler.ashx?mode=inf&pk='+pk; 
...
if(mode=='ins') url = 'ImportSampleSourceLog_handler.ashx?mode=ins';
if(mode=='upd') url = 'ImportSampleSourceLog_handler.ashx?mode=upd&pk='+pk;
