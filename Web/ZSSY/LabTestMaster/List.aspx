...
<!--Title -->
		...
		<asp:BoundField DataField="priorityIndicator" HeaderText="优先标志" SortExpression="priorityIndicator" ItemStyle-HorizontalAlign="Center"  Visible ="false" /> 
		...
		<asp:BoundField DataField="orderingProvider" HeaderText="医生工号" SortExpression="orderingProvider" ItemStyle-HorizontalAlign="Center" Visible ="false" /> 
		<asp:BoundField DataField="PerformedBy" HeaderText="执行科室" SortExpression="PerformedBy" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ResultStatus" HeaderText="执行情况" SortExpression="ResultStatus" ItemStyle-HorizontalAlign="Center" Visible ="false" /> 
		<asp:BoundField DataField="ResultsRptDateTime" HeaderText="报告完成时间" SortExpression="ResultsRptDateTime" ItemStyle-HorizontalAlign="Center" Visible ="false" /> 
		<asp:BoundField DataField="transcriptionist" HeaderText="报告者工号" SortExpression="transcriptionist" ItemStyle-HorizontalAlign="Center" Visible ="false" /> 
		<asp:BoundField DataField="VerifiedBy" HeaderText="审核者工号" SortExpression="VerifiedBy" ItemStyle-HorizontalAlign="Center" Visible ="false" /> 
