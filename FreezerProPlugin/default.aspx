<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="FreezerProPlugin.index" %>
...
<body id="body" runat="server">
    ...
    <div>
        ...
        <!--日期选择框-->
        <div id="dodatesearch" class="easyui-dialog" title="请选择日期" style="width: 400px; padding: 10px 10px 10px 10px;" data-options="closed:true">
            <form id="dateform">
        ...
        <!--条码输入框-->
        <div id="barcodeiputbox" class="easyui-dialog" title="请输入条码"  data-options="closed:true">
    ...
    <!--主体显示面板-->
    <div id="mainopanels" class="easyui-window" title="FP功能扩展" style="width: 80%; height: 60%;"
        data-options="closed:true,onResize:function(){$(this).window('hcenter');}">
        <!--菜单按钮区-->
        <div id="menu" style="padding: 5px,10px">
            <a id="savechange" name="barcodeimportbtn" href="javascript:void(0)" class="easyui-linkbutton" onclick="accept()">保存</a>
            <a id="menzhenhaoimportbtn" name="barcodeimportbtn" href="javascript:void(0)" class="easyui-linkbutton" onclick="removeSelections()">删除</a>
            <a id="barcodeimportbtn" name="barcodeimportbtn" href="javascript:void(0)" class="easyui-linkbutton" onclick="openbarcodeiputbox()">条码查询</a>
            <a id="dateimportbtn" name="dateimportbtn" href="javascript:void(0)" class="easyui-linkbutton" onclick="doquerydatabytime()">日期查询</a>
            <a id="batchImport" name="batchImport" href="javascript:void(0)" class="easyui-linkbutton" onclick="batchImport()">批量导入</a>
            <a id="respondhis" name="barcodeimportbtn" href="javascript:void(0)" class="easyui-linkbutton" onclick="reshis()">回发</a>
        </div>
        <!--显示面板-->
        <div id="dgcontent" style="width: 100%;">
            <table id="sampleSourceDataGrid" class="easyui-datagrid" title="样品源信息" style="width: auto"
                data-options="onClickRow: onClickRow,singleSelect: false,checkOnSelect:true,rownumbers:true,toolbar: '#menu'" width="100%">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'patientName'" width="5%">姓名</th>
                        <th data-options="field:'importStatus'" width="10%">状态</th>
                        <th data-options="field:'scheduledDateTime'" width="10%">预约手术日期</th>
                        <th data-options="field:'diagBeforeOperation'" width="20%">主要诊断</th>
                        <th data-options="field:'KeepSpecimenSign'" width="5%" style="align-content: center">是否取样</th>
                        <th data-options="field:'LabInfo'" width="5%" style="align-content: center">致病性</th>
